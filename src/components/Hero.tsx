      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
        <div className="text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
            A 0-3 week intensive <span className="text-teal-400 font-semibold">web development bootcamp</span> where you'll receive
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            <div className="flex items-center space-x-2 text-orange-400">
              ...
              <span className="font-semibold">July 03, 2025</span>
            </div>
            ...
            <div className="flex items-center space-x-2 text-orange-400">
              ...
              <span className="font-semibold">Hackathon Finale</span>
            </div>
          </div>
        ...
        <div className="mt-20 grid md:grid-cols-4 gap-6">
          {[{ week: 'Week 0', theme: 'Kick off & Basics' },
            { week: 'Week 1', theme: 'Foundation Building' },
            { week: 'Week 2',  theme: 'Advanced Implementation' },
            { week: 'Week 3',  theme: 'Grand Hackathon' },
          ].map((week, index) => (
            <div key={index} className="bg-white/10 backdrop-blur-md rounded-lg p-6 border border-teal-400/30 hover:border-orange-400/50 transition-all duration-300">
              ...
              <p className="text-teal-400 font-semibold mb-2">{week.theme}</p>
            </div>
          ))}
        </div>
      </div>
