        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-gray-300 mb-4">
              An intensive 3-week development bootcamp where you'll build real projects, 
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-300 hover:text-teal-400 transition-colors">Application Guide</a></li>
              <li><a href="#" className="text-gray-300 hover:text-teal-400 transition-colors">Technical Requirements</a></li>
              <li><a href="#" className="text-gray-300 hover:text-teal-400 transition-colors">Code of Conduct</a></li>
              <li><a href="#" className="text-gray-300 hover:text-teal-400 transition-colors">Learning Resources</a></li>
              <li><a href="#" className="text-gray-300 hover:text-teal-400 transition-colors">Alumni Network</a></li>
            </ul>
          </div>
